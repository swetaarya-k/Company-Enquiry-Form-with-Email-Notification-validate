...
export default function EnquiryForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post("/api/contact", form, { timeout: 20000 });
      ...
      if (error.response) {
        ...
        if (serverMessage && serverMessage.includes("duplicate")) {
          setErrorMsg("❌ This email ID is already used or submitted.");
        } else {
